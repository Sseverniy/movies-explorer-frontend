...
function Movies({movies, checkMovies, savedMovies, cardCounter, cardCounterMore, saveMovie, deleteMovie}) {
  ...
  return (
    <>
      <section className="movies">
        ...
        {loading ? <Preloader /> : <MoviesCardList movies={moviesList} savedMovies={savedMovies} checkMovies={checkMovies} changePreloaderStatus={changePreloaderStatus} cardCounter={cardCounter} cardCounterMore={cardCounterMore} saveMovie={saveMovie} deleteMovie={deleteMovie}/>}
      </section>
      <Footer />
    </>
  );
